...
test_stdlib_security_path_make_dir__invalid_args__@vary() {
  ...
  _capture_rc stdlib.security.path.make.dir "${args[@]}"
...
test_stdlib_security_path_make_dir__valid_args____calls_secure() {
  ...
  stdlib.security.path.secure.mock.assert_called_once_with "MOCK_PATH MOCK_USER MOCK_GROUP MOCK_PERM"
}

test_stdlib_security_path_make_dir__valid_args____returns_status_code_0() {
  _capture_rc stdlib.security.path.make.dir "MOCK_PATH" "MOCK_USER" "MOCK_GROUP" "MOCK_PERM"
