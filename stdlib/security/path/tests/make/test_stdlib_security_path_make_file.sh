...
test_stdlib_security_path_make_file__valid_args____calls_mkdir() {
  stdlib.security.path.make.file "/var/log/logfile" "MOCK_USER" "MOCK_GROUP" "MOCK_PERM"

  mkdir.mock.assert_called_once_with "-p /var/log"
}

test_stdlib_security_path_make_file__valid_args____calls_touch() {
  stdlib.security.path.make.file "/var/log/logfile" "MOCK_USER" "MOCK_GROUP" "MOCK_PERM"

  touch.mock.assert_called_once_with "/var/log/logfile"
}

test_stdlib_security_path_make_file__valid_args____calls_secure() {
  stdlib.security.path.make.file "/var/log/logfile" "MOCK_USER" "MOCK_GROUP" "MOCK_PERM"

  stdlib.security.path.secure.mock.assert_called_once_with "/var/log/logfile MOCK_USER MOCK_GROUP MOCK_PERM"
}
