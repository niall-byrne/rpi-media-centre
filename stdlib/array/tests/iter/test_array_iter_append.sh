...
# shellcheck disable=SC2034
test_stdlib_array_iter_append__empty_string___returns_status_code_0() {
  local test_array=("1" "2" "3")
...
# shellcheck disable=SC2034
test_stdlib_array_iter_append__empty_string___updates_array() {
  local test_array=("1" "2" "3")
  local expected_array=("1" "2" "3")

  stdlib.array.iter.append "" "test_array"
