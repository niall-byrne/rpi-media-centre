...
test_stdlib_string_array_iter_fn__@vary() {
  local args=()
  local empty_array=()
  local test_array=()
...
# shellcheck disable=SC2034
test_stdlib_string_array_iter_fn__valid_args__________default_delimiter__single_element_____applies_fn() {
...
# shellcheck disable=SC2034
test_stdlib_string_array_iter_fn__valid_args__________default_delimiter__multiple_elements__applies_fn() {
...
# shellcheck disable=SC2034
test_stdlib_string_array_iter_fn__empty_array_________default_delimiter__single_element_____applies_fn() {
  expected_array=()
  test_array=()
...
# shellcheck disable=SC2034
test_stdlib_string_array_iter_fn__empty_array_________default_delimiter__multiple_elements__applies_fn() {
  expected_array=()
  test_array=()
