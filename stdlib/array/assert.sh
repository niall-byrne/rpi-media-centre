...
# The function compares the lengths and elements of both arrays.
...
# @exitcode 0 If the value is an array.
# @exitcode 1 If the value is not an array.
# @exitcode 127 If invalid arguments are provided.
...
# @exitcode 126 If the value is not an array.
# @exitcode 127 If invalid arguments are provided.
