...
_testing.load "${STDLIB_DIRECTORY}/string/tests/map/__fixtures__/map_fn.sh"
...
test_stdlib_string_map_fn__null_input____________default_delimiter__single_line__applies_fn() {
  _capture.output_raw stdlib.string.map.fn _uppercase ""
