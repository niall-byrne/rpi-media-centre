...
test_stdlib_string_join__@vary() {
  local args=()
...
test_stdlib_string_join__valid_args_____arg___default_line_ending__correct_output() {
...
test_stdlib_string_join__valid_args_____arg___windows_line_ending__correct_output() {
  TEST_EXPECTED="string1 string2 string3 "
  TEST_INPUT="string1 "$'\r\n'"string2 "$'\r\n'"string3 "$'\r\n'
...
test_stdlib_string_join__null_input_____arg___windows_line_ending__correct_output() {
  TEST_INPUT=""
