...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "invalid_input____returns_status_code_126,20|80||,126" \
...
test_stdlib_string_wrap__valid_args_______arg___wrapped_string__pad_width_5__wrap_20__correct_output() {
  TEST_EXPECTED="this is a"$'\n'"     string of text"$'\n'"     that i would"$'\n'"     like to wrap"
  TEST_INPUT="this is a string of text that i would like to wrap"
