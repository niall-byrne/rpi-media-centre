...
test_stdlib_colour_substring_@vary() {
  ...
  _capture_rc stdlib.string.colour.substring "${args[@]}" > /dev/null
...
test_stdlib_colour_substring__valid_args_____red___________correct_output() {
  ...
  _capture_stdout_raw stdlib.string.colour.substring "RED" "string" "${TEST_INPUT}"
...
test_stdlib_colour_substring__valid_args_____green_________correct_output() {
  ...
  _capture_stdout_raw stdlib.string.colour.substring "GREEN" "string" "${TEST_INPUT}"
...
test_stdlib_colour_substring__valid_args_____non_existent__correct_output() {
  ...
  _capture_stdout_raw stdlib.string.colour.substring "NON_EXISTENT" "string" "${TEST_INPUT}"
