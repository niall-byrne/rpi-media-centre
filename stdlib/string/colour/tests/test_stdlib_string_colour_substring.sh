...
test_stdlib_colour_substring__valid_args_____red______________________correct_output() {
...
test_stdlib_colour_substring__empty_string___red______________________correct_output() {
  TEST_INPUT=""
...
test_stdlib_colour_substring__valid_args_____green____________________correct_output() {
...
test_stdlib_colour_substring__empty_string___green____________________correct_output() {
  TEST_INPUT=""
...
test_stdlib_colour_substring__valid_args_____non_existent_____________correct_output() {
  TEST_INPUT="test string 1 string coloured"
