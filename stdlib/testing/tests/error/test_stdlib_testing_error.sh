...
test_stdlib_testing_error__no_args________returns_status_code_127() {
  _capture.rc _testing.error > /dev/null
...
test_stdlib_testing_error__single_arg_____returns_status_code_127() {
  _capture.rc _testing.error > /dev/null
...
test_stdlib_testing_error__multiple_args__returns_status_code_127() {
  _capture.rc _testing.error > /dev/null
