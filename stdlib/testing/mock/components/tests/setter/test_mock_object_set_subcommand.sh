...
test_mock_object__set.subcommand__@vary__calls_subcommand_as_expected() {
  _mock.create test_mock
  _mock.create curl
  curl.mock.set.stdout "simulating file down_testing.load..."
...
@parametrize \
  ...
  "curl_command,curl \\\$1,simulating file down_testing.load..."
