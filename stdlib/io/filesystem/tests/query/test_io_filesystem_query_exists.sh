...
test_stdlib_io_filesystem_query_exists__valid_args_________test_is_called_with_expected_args() {
  stdlib.io.filesystem.query.exists "/some/file"

  test.mock.assert_called_once_with "-e /some/file"
}
