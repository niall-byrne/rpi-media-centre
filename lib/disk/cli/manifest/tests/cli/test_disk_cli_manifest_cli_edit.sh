...
setup() {
  ...
  _disk_cli_manifest_cli_details.mock.set.stdout "mock manifest help"
}

test_disk_cli_manifest_cli_edit__file_exists__________does_not_template_a_manifest() {
  stdlib.io.path.query.is_file.mock.set.rc 0

  _disk_cli_manifest_cli_edit

  _disk_cli_manifest_cli_details.mock.assert_not_called
  stdlib.security.path.secure.mock.assert_not_called
}

test_disk_cli_manifest_cli_edit__file_exists__________edits_the_manifest() {
  stdlib.io.path.query.is_file.mock.set.rc 0
...
test_disk_cli_manifest_cli_edit__file_exists__________checks_the_manifest() {
  stdlib.io.path.query.is_file.mock.set.rc 0
...
test_disk_cli_manifest_cli_edit__file_does_not_exist__templates_a_new_manifest() {
...
test_disk_cli_manifest_cli_edit__file_does_not_exist__new_manifest_has_expected_content() {
  stdlib.io.path.query.is_file.mock.set.rc 1
...
test_disk_cli_manifest_cli_edit__file_does_not_exist__edits_the_new_manifest() {
  stdlib.io.path.query.is_file.mock.set.rc 1
...
test_disk_cli_manifest_cli_edit__file_does_not_exist__checks_the_new_manifest() {
  stdlib.io.path.query.is_file.mock.set.rc 1
