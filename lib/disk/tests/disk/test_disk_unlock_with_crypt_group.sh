...
test_disk_unlock_with_crypt_group__3_disks__3_crypt_groups__calls_stdlib_io_stdin_prompt_3_times() {
  ...
  assert_equals "3" "$(stdlib.io.stdin.prompt.mock.get.count)"
  assert_equals \
...
Enter the password for disk group 'group3':  RPI_DISK_CRYPT_PASSWORD password" \
    "$(stdlib.io.stdin.prompt.mock.get.calls)"
}
...
test_disk_unlock_with_crypt_group__3_disks__2_crypt_groups__calls_stdlib_io_stdin_prompt_2_times() {
  ...
  assert_equals "2" "$(stdlib.io.stdin.prompt.mock.get.count)"
  assert_equals \
    "Enter the password for disk group 'group1':  RPI_DISK_CRYPT_PASSWORD password
Enter the password for disk group 'group2':  RPI_DISK_CRYPT_PASSWORD password" \
    "$(stdlib.io.stdin.prompt.mock.get.calls)"
...
test_disk_unlock_with_crypt_group__3_disks__1_crypt_groups__calls_stdlib_io_stdin_prompt_1_times() {
  ...
  assert_equals "1" "$(stdlib.io.stdin.prompt.mock.get.count)"
  assert_equals \
    "Enter the password for disk group 'group1':  RPI_DISK_CRYPT_PASSWORD password" \
    "$(stdlib.io.stdin.prompt.mock.get.calls)"
}
