...
test_disk_manifest_line_log_all__calls_logging_bumper_messages() {
  ...
  _cli_log_notice.mock.assert_call_n_is "1" \
    "1(== Start of Disk '${TEST_MOCK_DISK_NAME_1}' ==)"
  _cli_log_notice.mock.assert_call_n_is "2" \
    "1(== End of Disk '${TEST_MOCK_DISK_NAME_1}' ==)"
}
