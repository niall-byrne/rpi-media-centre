...
test_config_pictl_help__calls_highlight() {
  _config_pictl_help > /dev/null
...
test_config_pictl_help__calls_grep_as_expected() {
  _config_pictl_help > /dev/null
...
test_config_pictl_help__grep_output_is_passed_to_cli_pretty_markdown() {
  _config_pictl_help > /dev/null
...
test_config_pictl_help__pretty_markdown_is_piped_to_pretty_columns() {
  _config_pictl_help > /dev/null
...
test_config_pictl_help__outputs_expected_info_message() {
  local RPI_PROJECT_REPOSITORY="https://some/url.com"

  _capture.output _config_pictl_help
