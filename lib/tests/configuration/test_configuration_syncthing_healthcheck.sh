...
test_configuration_syncthing_setting__simulated_success__calls_curl_once_correctly() {
...
test_configuration_syncthing_setting__simulated_success__does_not_call_sleep() {
  _configuration_syncthing_healthcheck

  sleep.mock.assert_not_called
}

test_configuration_syncthing_setting__simulated_failure__calls_curl_until_success() {
...
test_configuration_syncthing_setting__simulated_failure__calls_sleep_after_each_curl_call() {
  local TEST_CURL_CALL_COUNT=0
