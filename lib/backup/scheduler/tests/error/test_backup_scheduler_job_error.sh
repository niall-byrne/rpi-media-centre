...
test_backup_scheduler_error__@vary__no_scheduling_error__logs_expected_errors() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"

  mock_job.mock.set.rc 0

  _backup_scheduler_error "${TEST_QUEUE_NAME}" mock_job
...
# shellcheck disable=SC2034
test_backup_scheduler_error__@vary__no_scheduling_error__calls_mock_job_with_failed_status() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"
...
test_backup_scheduler_error__@vary__no_scheduling_error__does_not_generate_scheduler_error_event() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"
...
# shellcheck disable=SC2034
test_backup_scheduler_error__@vary__scheduling_error_____logs_expected_errors() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"
...
# shellcheck disable=SC2034
test_backup_scheduler_error__@vary__scheduling_error_____calls_mock_job_with_failed_status() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"
...
test_backup_scheduler_error__@vary__scheduling_error_____generates_scheduler_error_event() {
  local RPI_BACKUP_JOB_NAME="${TEST_JOB_NAME}"
