...
setup() {
  ...
  _mock.create _backup_scheduler_forward
  _mock.create _backup_scheduler_error
...
test_backup_scheduler_execute__@vary__@vary__calls_basename_to_identify_job() {
  _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job
...
test_backup_scheduler_execute__@vary__starts_the_job_with_status_ok() {
...
test_backup_scheduler_execute__@vary__returns_status_code_0() {
  _capture.rc _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job
...
test_backup_scheduler_execute__@vary__logs_expected_messages() {
  _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job
...
test_backup_scheduler_execute__@vary__promotes_job() {
  _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job

  _backup_scheduler_forward.mock.assert_called_once_with \
...
test_backup_scheduler_execute__@vary__does_not_log_success_message() {
  _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job
...
test_backup_scheduler_execute__@vary__calls_scheduler_job_error() {
  _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job

  _backup_scheduler_error.mock.assert_called_once_with \
...
test_backup_scheduler_execute__@vary__still_returns_status_code_0() {
  _capture.rc _backup_scheduler_execute "${TEST_QUEUE1_NAME}" mock_job
