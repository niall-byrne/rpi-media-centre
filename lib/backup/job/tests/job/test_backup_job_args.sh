...
@parametrize_with_success_args() {
  ...
  @parametrize \
    ...
    "all_options_______;-b|/path_tarball|-k|/path_encryption_key|-n|job_name|-p|remote_parameter|-q|queue_name|-r|/path_rsync|-s|/path_source|-t|remote_target://path|-v|version_count" \
    "missing_tarball___;-k|/path_encryption_key|-n|job_name|-p|remote_parameter|-q|queue_name|-r|/path_rsync|-s|/path_source|-t|remote_target://path|-v|version_count" \
    "missing_encryption;-n|job_name|-p|remote_parameter|-q|queue_name|-r|/path_rsync|-s|/path_source|-t|remote_target://path|-v|version_count" \
    "no_args___________;;"
}
...
_fixture_environment_variable_positions() {
  ...
  case "${PARAMETRIZE_SCENARIO_NAME}" in
    all_options_______)
      TEST_VARIABLE_PAIR_DEFINITION="RPI_BACKUP_JOB_LOCAL_TARBALL_FOLDER|1 RPI_BACKUP_JOB_REMOTE_ENCRYPTION_KEY_PATH|3 RPI_BACKUP_JOB_NAME|5 RPI_BACKUP_JOB_REMOTE_PARAMETER|7 RPI_BACKUP_JOB_QUEUE|9 RPI_BACKUP_JOB_LOCAL_RSYNC_FOLDER|11 RPI_BACKUP_JOB_LOCAL_SOURCE|13 RPI_BACKUP_JOB_REMOTE_TARGET|15 RPI_BACKUP_JOB_LOCAL_TARBALL_VERSIONS|17"
      ;;
    missing_tarball___)
      TEST_VARIABLE_PAIR_DEFINITION="RPI_BACKUP_JOB_REMOTE_ENCRYPTION_KEY_PATH|1 RPI_BACKUP_JOB_NAME|3 RPI_BACKUP_JOB_REMOTE_PARAMETER|5 RPI_BACKUP_JOB_QUEUE|7 RPI_BACKUP_JOB_LOCAL_RSYNC_FOLDER|9 RPI_BACKUP_JOB_LOCAL_SOURCE|11 RPI_BACKUP_JOB_REMOTE_TARGET|13 RPI_BACKUP_JOB_LOCAL_TARBALL_VERSIONS|15"
      ;;
    missing_encryption)
      TEST_VARIABLE_PAIR_DEFINITION="RPI_BACKUP_JOB_NAME|1 RPI_BACKUP_JOB_REMOTE_PARAMETER|3 RPI_BACKUP_JOB_QUEUE|5 RPI_BACKUP_JOB_LOCAL_RSYNC_FOLDER|7 RPI_BACKUP_JOB_LOCAL_SOURCE|9 RPI_BACKUP_JOB_REMOTE_TARGET|11 RPI_BACKUP_JOB_LOCAL_TARBALL_VERSIONS|13"
      ;;
    no_args___________)
...
test_backup_job_args__@vary__@vary__environment_variables_are_set_as_expected() {
  local command_args
  local variable_pair=()
