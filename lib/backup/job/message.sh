...
_backup_job_message_remote_param() {
  ...
  _cli_pretty_bullet_point "STANDARD " "3" | _cli_pretty_strip_trailing_newline_pipe
...
_backup_job_message_queue() {
  ...
  _cli_pretty_justify_left "10" "rsync" | _cli_pretty_bullet_point_pipe - "3" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_info "- create rsync copy"
  _cli_pretty_justify_left "10" "tar" | _cli_pretty_bullet_point_pipe - "3" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_info "- create tar bundle"
  _cli_pretty_justify_left "10" "upload" | _cli_pretty_bullet_point_pipe - "3" | _cli_pretty_strip_trailing_newline_pipe
...
_backup_job_message_remote_target() {
  ...
  _cli_pretty_bullet_point "s3:" "3" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_detail "//" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_entity "bucket_name" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_detail "/" | _cli_pretty_strip_trailing_newline_pipe
...
_backup_job_message_tarball_versions() {
  ...
  _cli_pretty_bullet_point "any number between" "3" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_detail " 1 " | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_entity "and" | _cli_pretty_strip_trailing_newline_pipe
  _cli_pretty_detail " 9 " | _cli_pretty_strip_trailing_newline_pipe
