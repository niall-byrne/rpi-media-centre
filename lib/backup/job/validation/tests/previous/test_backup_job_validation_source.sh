...
test_backup_job_validation_source__@vary__calls_is_exists() {
  local RPI_SVC_USERNAME="${TEST_SVC_USERNAME}"
  local RPI_SVC_GROUPNAME="${TEST_SVC_GROUPNAME}"

  _backup_job_validation_source "${TEST_PATH}" "${TEST_PERMISSION}"
...
# shellcheck disable=SC2034
test_backup_job_validation_source__@vary__calls_is_octal_permission() {
  local RPI_SVC_USERNAME="${TEST_SVC_USERNAME}"
  local RPI_SVC_GROUPNAME="${TEST_SVC_GROUPNAME}"
...
# shellcheck disable=SC2034
test_backup_job_validation_source__@vary__calls_is_secure() {
  local RPI_SVC_USERNAME="${TEST_SVC_USERNAME}"
  local RPI_SVC_GROUPNAME="${TEST_SVC_GROUPNAME}"
