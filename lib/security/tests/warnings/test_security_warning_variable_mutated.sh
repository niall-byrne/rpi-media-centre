...
test_security_warning_variable_mutated__@vary__logs_warning_messages() {
  ...
  _cli_log_warning.mock.assert_called_once_with \
    "1(SECURITY: The configured NEW_VALUE value has been overridden due to the value of RESPONSIBLE_ENTITY.)"
  _cli_log_info.mock.assert_called_once_with \
    "1(Please consider removing the unnecessary NEW_VALUE value.)"
}
