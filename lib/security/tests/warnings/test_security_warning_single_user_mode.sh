...
test_security_warning_single_user_mode__@vary__logs_warning_messages() {
  local EXPECTED_WARNING_MESSAGES=(
    "SECURITY: pictl is running in single user mode"
    "  Concurrent user access is not supported."
  )
  local EXPECTED_INFO_MESSAGES=(
    "Consider appending the following to your /etc/rpi/config file:"
    '  RPI_SVC_USERNAME="service_account_username"'
    "Please see the documentation for further details or to learn how to silence this warning."
  )
...
test_security_warning_single_user_mode__@vary__does_not_log_warning_messages() {
  _security_warning_single_user_mode
