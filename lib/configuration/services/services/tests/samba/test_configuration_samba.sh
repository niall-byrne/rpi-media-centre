...
test_configuration_service_samba__@vary__copies_correct_config() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc "${TEST_IS_FILE_RC}"

  _configuration_service_samba
...
test_configuration_service_samba__samba_yml_does_not_exist__does_not_log_a_notice_message() {
  local RPI_SAMBA_PATH_CONFIG="/config"
...
test_configuration_service_samba__samba_yml_exists__________logs_notice_message() {
  local RPI_SAMBA_PATH_CONFIG="/config"
...
test_configuration_service_samba__samba_yml_does_not_exist__does_not_check_file_security() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc 1
...
test_configuration_service_samba__samba_yml_exists__________checks_file_security() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc 0
...
test_configuration_service_samba__@vary__prompts_for_credentials() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc "${TEST_IS_FILE_RC}"
...
test_configuration_service_samba__@vary__creates_dir_for_docker_env_file() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc "${TEST_IS_FILE_RC}"
...
test_configuration_service_samba__@vary__creates_docker_env_file() {
  local RPI_SAMBA_PATH_CONFIG="/config"
  stdlib.io.path.query.is_file.mock.set.rc "${TEST_IS_FILE_RC}"
