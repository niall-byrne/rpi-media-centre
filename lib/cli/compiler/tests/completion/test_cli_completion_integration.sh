...
# shellcheck disable=SC2034
test_cli_completion__@vary__generates_expected_cli_content() {
  local RPI_PATH_FRAGMENTS="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/fragments"
  ...
  _cli_compiler_completion > /dev/null 2>&1

  TEST_OUTPUT="$(cat "${test_path_compiled_content}")"
  assert_snapshot "${RPI_WORKING_DIRECTORY}/lib/cli/compiler/tests/__fixtures__/${TEST_SCENARIO_NAME}_compiled_completion_snapshot.sh"
}
...
# shellcheck disable=SC2034
test_cli_completion__@vary__logs_expected_warning_message() {
  local RPI_PATH_FRAGMENTS="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/fragments"
  local RPI_PATH_COMPILED_ROOT="${test_path_compiled_root}"
  local RPI_PATH_COMPILED_COMPLETION="${test_path_compiled_content}"
  local RPI_PATH_COMPILED_CLI_SOURCE="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/tests/__fixtures__/${TEST_SCENARIO_NAME}_cli_configuration.txt"
...
# shellcheck disable=SC2034
test_cli_completion__@vary__generates_expected_output_content() {
  local RPI_PATH_FRAGMENTS="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/fragments"
  local RPI_PATH_COMPILED_ROOT="${test_path_compiled_root}"
  local RPI_PATH_COMPILED_COMPLETION="${test_path_compiled_content}"
  local RPI_PATH_COMPILED_CLI_SOURCE="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/tests/__fixtures__/${TEST_SCENARIO_NAME}_cli_configuration.txt"
  ...
  _capture.output _cli_compiler_completion
...
# shellcheck disable=SC2034
test_cli_completion__@vary__logs_expected_success_message() {
  local RPI_PATH_FRAGMENTS="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/fragments"
  local RPI_PATH_COMPILED_ROOT="${test_path_compiled_root}"
  local RPI_PATH_COMPILED_COMPLETION="${test_path_compiled_content}"
  local RPI_PATH_COMPILED_CLI_SOURCE="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/tests/__fixtures__/${TEST_SCENARIO_NAME}_cli_configuration.txt"
...
# shellcheck disable=SC2034
test_cli_completion__@vary__logs_in_the_correct_sequence() {
  local RPI_PATH_FRAGMENTS="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/fragments"
  local RPI_PATH_COMPILED_ROOT="${test_path_compiled_root}"
  local RPI_PATH_COMPILED_COMPLETION="${test_path_compiled_content}"
  local RPI_PATH_COMPILED_CLI_SOURCE="${RPI_WORKING_DIRECTORY}/lib/cli/compiler/tests/__fixtures__/${TEST_SCENARIO_NAME}_cli_configuration.txt"
